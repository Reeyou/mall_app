...
export default class BaseCard extends Component {
  ...
  backgroundDoubleCell(style) {
    return (
      <View style={[styles.b_doubleCell, style]}>
        ...
        <View style={[styles.smallPicWrapper, styles.b_d_smallPic]}>
          <Image
            style={[styles.smallPic, styles.d_c_smallPic]}
  ...
  doubleCell(style) {
    return (
      <View style={[styles.doubleCell, style]}>
